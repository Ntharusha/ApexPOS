...
import RepairLiability from './pages/RepairLiability';
import TableTurnaround from './pages/TableTurnaround';
            ...
            <Routes>
                ...
                <Route element={<ProtectedRoute />}>
                    <Route path="/" element={<Layout />}>
                        ...
                        <Route path="liability" element={<RepairLiability />} />
                        <Route path="turnaround" element={<TableTurnaround />} />
                    </Route>
